# Generated by Django 4.1.3 on 2023-01-06 07:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('txt_description', models.TextField()),
                ('ch_agent', models.CharField(default='Deallocate', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ch_title', models.CharField(max_length=100, null=True)),
                ('dt_start_date', models.DateTimeField(blank=True, null=True)),
                ('dt_end_date', models.DateTimeField(blank=True, null=True)),
                ('ch_parent_change', models.CharField(max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dt_end_of_warranty', models.DateField(default=datetime.datetime)),
                ('txt_description', models.TextField()),
                ('ch_brand', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='tool.cl_brand')),
                ('ch_model', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='tool.cl_model')),
                ...
                ('ch_organization', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='tool.cl_new_organization')),
                ('i_os_version', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='tool.cl_ios_version')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ch_status', models.CharField(default='active', max_length=100)),
                ('ch_owner_organization', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='tool.cl_new_organization')),
            ],
            options={
