    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('duration', models.DateTimeField(default=datetime.datetime(2023, 2, 16, 10, 47, 13, 929424))),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(editable=False, primary_key=True, serialize=False)),
                ('sla_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='tool.cl_sla')),
                ('slt_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='tool.cl_slt')),
            ],
        ),
        migrations.CreateModel(
